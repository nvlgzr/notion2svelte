...
<svelte:head>
	<title>Circular Reference 4</title>
</svelte:head><Title>Circular Reference 4</Title>
...
{#if !curtainDrawn}
	<div>
		I reference&thinsp;<a href="cr3">Circular Reference 3</a>&thinsp;and&thinsp;<a href="cr1"
			>Circular Reference 1</a
		>&thinsp;
	</div>
...
{:else}
  ...
  {
    "object": "block",
    "id": "b6534a74-466a-479b-acd6-6febc3c2a417",
    "created_time": "2021-11-05T10:48:00.000Z",
    "last_edited_time": "2021-11-05T10:48:00.000Z",
    "has_children": false,
    "archived": false,
    "type": "paragraph",
    "paragraph": {
      "text": [
        ...
        },
        {
          ...
          "href": "https://www.notion.so/67f0e3a3711f431abbfd6ae92bc2df79"
        },
        {
          "type": "text",
          "text": {
  ...
  "url": "https://www.notion.so/Circular-Reference-4-8c44a13e832f47c38650e9e647d9bde4",
  "blocks": "…see above"
}, null, 2)}</pre>
{/if}
