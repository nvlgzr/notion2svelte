...
<button on:click={() => curtainDrawn = !curtainDrawn}>𒅒 Brought to you by @nvlgzr/notion2svelte 1.0.0 𒅒</button>
  ...
  "url": "https://www.notion.so/Cover-Only-8eb305de5ebe43a480cb0ec7c9df5ab7",
  "blocks": [
    {
      "object": "block",
      "id": "cd11e09a-b42d-4fb7-a6b2-c7aac14d3591",
      "created_time": "2021-11-03T07:11:00.000Z",
    ...
    {
      "object": "block",
      "id": "fe6275e3-0139-417d-ba12-0f73ac552adf",
      "created_time": "2021-11-03T07:11:00.000Z",
      "last_edited_time": "2021-11-06T10:01:00.000Z",
      "has_children": false,
      "archived": false,
    ...
    {
      "object": "block",
      "id": "c4dd720a-30eb-41da-8be9-8f30684f3446",
      "created_time": "2021-11-03T07:11:00.000Z",
      "last_edited_time": "2021-11-03T07:11:00.000Z",
      "has_children": false,
      "archived": false,
...
}, null, 2)} show={curtainDrawn}><h1>Sea Otters!</h1>
</Magic> 
...
<Magic page={JSON.stringify({
  ...
  "type": "divider",
  "divider": {}
}, null, 2)} show={curtainDrawn}><Divider />
</Magic> 
<br style="display:none;"/>
<Magic page={JSON.stringify({
  "object": "page",
...
}, null, 2)} show={curtainDrawn}><div>
With any luck, this should link to the&thinsp;<a href="bells-and-whistles">bells and whistles page</a>.
</div>
</Magic> 
<br style="display:none;"/>
