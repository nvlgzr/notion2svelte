  ...
  "paragraph": {
    "text": [
      ...
      },
      {
        "type": "text",
        "text": {
          "content": " blocks are supported, but so are the 6 annotation types used to format sub-strings in a block:",
          "link": null
        },
        "annotations": {
          "bold": false,
        ...
        "plain_text": " blocks are supported, but so are the 6 annotation types used to format sub-strings in a block:",
        "href": null
      }
    ]
  },
...
Obviously&thinsp;<InlineCode>text</InlineCode>&thinsp;blocks are supported, but so are the 6 annotation types used to format sub-strings in a block:
</div>
<IndentGroup>
...
<IndentGroup>
  <NumberedListItem number=a> "Dismiss":&thinsp;<MagicLink href="http://ilovelife.com/">http://ilovelife.com</MagicLink></NumberedListItem>
            ...
            "text": [
              {
                "type": "text",
                "text": {
                  "content": "Not sure whether the Notion API supports column sizing at all. It doesn't seem to support image sizing, fwiw.",
                  "link": null
                },
                "annotations": {
                  "bold": false,
                ...
                "plain_text": "Not sure whether the Notion API supports column sizing at all. It doesn't seem to support image sizing, fwiw.",
                "href": null
              }
            ]
          }
...
At this point, inline- and block equations just get formatted kinda like&thinsp;<InlineCode>code</InlineCode>. In future, I hope to add Katex interpretation. Here's an inline equation…&thinsp;⟣<InlineCode>E = mc^2</InlineCode>⟢… and here's a block equation:
</div>
</Magic> 
<br style="display:none;"/>
<Magic page={{
