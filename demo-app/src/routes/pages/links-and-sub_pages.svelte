...
{#if !curtainDrawn}
	<div>
		...
		>&thinsp;&&thinsp;<a href="cover-only">Cover Only</a>&thinsp;
	</div>
	...
	<br style="display:none;" />
	<ChildPage title="Hellooooo 🤓"
		><div>I'm the sub-page</div>
		<h1>I'm all about the lorem</h1>
		<div>Lorem ipsum lorem ipsum</div>
		<div>I'm all about the lorem</div>
		<div>Lorem ipsum lorem ipsum</div>
		<div>
...
{:else}
      ...
      "text": [
        {
          "type": "text",
          "text": {
            "content": "Two sibling pages, @-mentioned → ",
            "link": null
          },
          "annotations": {
            "bold": false,
          ...
          "plain_text": "Two sibling pages, @-mentioned → ",
          "href": null
        },
        {
          "type": "mention",
        ...
        },
        {
          ...
          "plain_text": "Cover Only",
          "href": "https://www.notion.so/8eb305de5ebe43a480cb0ec7c9df5ab7"
        },
        {
          "type": "text",
          "text": {
  ...
  },
  {
    ...
    "last_edited_time": "2021-11-05T04:12:00.000Z",
    "has_children": true,
    "archived": false,
    "type": "toggle",
    "toggle": {
