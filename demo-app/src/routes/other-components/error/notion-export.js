const json = {
  ...
  "properties": {
    ...
    "Public URL": {
      ...
      "formula": {
        "type": "string",
        "string": "https://notion2svelte.vercel.app/other-components/error"
      }
    },
    "SomeDateProp": {
      "id": "UMpq",
    ...
    "Local URL": {
      ...
      "formula": {
        "type": "string",
        "string": "http://localhost:5173/other-components/error"
      }
    },
    "Name": {
      "id": "title",
  ...
  "url": "https://www.notion.so/Error-f8b93766ebbc4211a1e74d4475d3d8a4",
  "blocks": [
    {
      "object": "block",
      "id": "1d7c27f9-949e-4d9c-90c8-b928762999fd",
      "parent": {
        "type": "page_id",
        "page_id": "f8b93766-ebbc-4211-a1e7-4d4475d3d8a4"
      },
      "created_time": "2022-01-31T20:49:00.000Z",
      "last_edited_time": "2022-01-31T20:49:00.000Z",
      "created_by": {
        "object": "user",
        "id": "169a5357-f419-4e33-9165-e91e90a3646d"
      },
        ...
        "text": [
          {
            "type": "text",
            "text": {
              "content": "While in the middle of developing ",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": "While in the middle of developing ",
            "href": null
          },
          {
            "type": "text",
          ...
          },
          {
            "type": "text",
            "text": {
              "content": ", I became frustrated whenever some uncaught error would crash ",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": ", I became frustrated whenever some uncaught error would crash ",
            "href": null
          },
          {
            "type": "text",
          ...
          },
          {
            "type": "text",
            "text": {
              "content": ". First there would be the confusion of “why isn’t it rendering as I expected?”. Then there was an inevitable scramble to look in various consoles for an error.",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": ". First there would be the confusion of “why isn’t it rendering as I expected?”. Then there was an inevitable scramble to look in various consoles for an error.",
            "href": null
          }
        ]
      }
        ...
        "text": [
          {
            "type": "text",
            "text": {
              "content": "So I added a top-level catch-all for unexpected rendering errors that allows you to present them in-context and with as much (or as little!) visual presence as desired.",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": "So I added a top-level catch-all for unexpected rendering errors that allows you to present them in-context and with as much (or as little!) visual presence as desired.",
            "href": null
          }
        ]
      }
    ...
    {
      "object": "block",
      "id": "e7f99b34-6967-492f-861d-7a81a2757c47",
      "parent": {
        "type": "page_id",
        "page_id": "f8b93766-ebbc-4211-a1e7-4d4475d3d8a4"
      },
      "created_time": "2022-01-31T20:54:00.000Z",
      "last_edited_time": "2022-01-31T20:54:00.000Z",
      "created_by": {
        "object": "user",
        "id": "169a5357-f419-4e33-9165-e91e90a3646d"
      },
        ...
        "text": [
          {
            "type": "text",
            "text": {
              "content": "In the Notion database that hosts my source files for this site, I have a page called ",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": "In the Notion database that hosts my source files for this site, I have a page called ",
            "href": null
          },
          {
            "type": "text",
            "text": {
              "content": "README (For Visitors)",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": "README (For Visitors)",
            "href": null
          },
          {
            "type": "text",
            "text": {
              "content": ". I don’t ever intend to publish that file here, and so it has no slug, nor have I marked it Publishable before running ",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": ". I don’t ever intend to publish that file here, and so it has no slug, nor have I marked it Publishable before running ",
            "href": null
          },
          {
            "type": "text",
          ...
          },
          {
            "type": "text",
            "text": {
              "content": " doesn’t recognize it, and so it throws an error.",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": " doesn’t recognize it, and so it throws an error.",
            "href": null
          }
        ]
      }
        ...
        "text": [
          {
            "type": "text",
            "text": {
              "content": "Rather than bring the entire process to a halt or hoping that you notice an error in the Console, notion2svelte handles the error by rendering it right into your document using the ",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": "Rather than bring the entire process to a halt or hoping that you notice an error in the Console, notion2svelte handles the error by rendering it right into your document using the ",
            "href": null
          },
          {
            "type": "text",
          ...
          },
          {
            "type": "text",
            "text": {
              "content": " component. There, you can simply render something hideous and obviously wrong that you couldn’t possibly ship on accident, or you could maybe use the component to pass such errors through to a notification system, or to collate errors into a single report.",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": " component. There, you can simply render something hideous and obviously wrong that you couldn’t possibly ship on accident, or you could maybe use the component to pass such errors through to a notification system, or to collate errors into a single report.",
            "href": null
          }
        ]
      }
        ...
        "text": [
          {
            "type": "text",
            "text": {
              "content": "Ok, enough with the hypotheticals. Time for that demo.",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": "Ok, enough with the hypotheticals. Time for that demo.",
            "href": null
          }
        ]
      }
    ...
    {
      "object": "block",
      "id": "f518f49d-aa6b-4ccb-a0c4-c82078179896",
      "parent": {
        "type": "page_id",
        "page_id": "f8b93766-ebbc-4211-a1e7-4d4475d3d8a4"
      },
      "created_time": "2022-12-08T08:45:00.000Z",
      "last_edited_time": "2022-12-08T08:47:00.000Z",
      "created_by": {
        "object": "user",
        "id": "169a5357-f419-4e33-9165-e91e90a3646d"
      },
        ...
        "text": [
          ...
          },
          {
            ...
            "text": {
              "content": "↓ this page",
              "link": {
                "url": "https://notion.so/nvlgzr/README-For-Visitors-4bd575791670432f9125a2fb8d3d8af7"
              }
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": "↓ this page",
            "href": "https://notion.so/nvlgzr/README-For-Visitors-4bd575791670432f9125a2fb8d3d8af7"
          },
          {
            "type": "text",
            "text": {
              "content": " has never been marked Publishable during a local run of ",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": " has never been marked Publishable during a local run of ",
            "href": null
          },
          {
            "type": "text",
    ...
    {
      "object": "block",
      "id": "719944fb-1ec8-42b5-9e29-4d4f54a31f4f",
      "parent": {
        "type": "page_id",
        "page_id": "f8b93766-ebbc-4211-a1e7-4d4475d3d8a4"
      },
      "created_time": "2022-12-08T08:37:00.000Z",
      ...
      "image": {
        ...
        "type": "file",
        "file": {
          "url": "https://s3.us-west-2.amazonaws.com/secure.notion-static.com/393f9a64-e136-4ab5-9cca-cb5eba26f4d6/Untitled.png?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=AKIAT73L2G45EIPT3X45%2F20221208%2Fus-west-2%2Fs3%2Faws4_request&X-Amz-Date=20221208T091342Z&X-Amz-Expires=3600&X-Amz-Signature=c533702e4c338061d53951c829e22556d9f5974172d1f1448f2181450db8fbd5&X-Amz-SignedHeaders=host&x-id=GetObject"
        }
      }
    },
    {
        ...
        "text": [
          {
            "type": "text",
            "text": {
              "content": "…attempts to link to it fail because ",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": "…attempts to link to it fail because ",
            "href": null
          },
          {
            "type": "text",
          ...
          },
          {
            "type": "text",
            "text": {
              "content": " recognizes it as an internal site link, but can’t find a mapping for it in ",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": " recognizes it as an internal site link, but can’t find a mapping for it in ",
            "href": null
          },
          {
            "type": "text",
            "text": {
              "content": "notion2svelte_id-to-slug.json.",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": "notion2svelte_id-to-slug.json.",
            "href": null
          },
          {
            "type": "text",
            "text": {
              "content": " You don’t need to understand it. The point is, it’s enough to trigger a rendering error.",
              "link": null
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": " You don’t need to understand it. The point is, it’s enough to trigger a rendering error.",
            "href": null
          }
        ]
      }
    ...
    {
      "object": "block",
      "id": "ad194d5c-f231-4727-a00c-d122ec7852d1",
      "parent": {
        "type": "page_id",
        "page_id": "f8b93766-ebbc-4211-a1e7-4d4475d3d8a4"
      },
      "created_time": "2022-12-08T08:48:00.000Z",
      "last_edited_time": "2022-12-08T08:48:00.000Z",
      "created_by": {
        "object": "user",
        "id": "169a5357-f419-4e33-9165-e91e90a3646d"
      },
        ...
        "text": [
          {
            ...
            "plain_text": "2. Example rendering",
            "href": null
          }
        ]
      }
        ...
        "text": [
          ...
          },
          {
            ...
            "text": {
              ...
              "link": {
                "url": "https://github.com/nvlgzr/notion2svelte/blob/main/demo-app/src/lib/notion2svelte/Error.svelte"
              }
            },
            "annotations": {
              "bold": false,
        ...
        "text": [
          {
            ...
            "mention": {
              "type": "page",
              "page": {
                "id": "4bd57579-1670-432f-9125-a2fb8d3d8af7"
              }
            },
            "annotations": {
              "bold": false,
            ...
            "plain_text": "README (For Visitors)",
            "href": "https://www.notion.so/4bd575791670432f9125a2fb8d3d8af7"
          }
        ]
      }
    },
    ...
    {
      "object": "block",
      "id": "946593ef-c816-4de1-9240-18e06f7d61f9",
      "parent": {
        "type": "page_id",
        "page_id": "f8b93766-ebbc-4211-a1e7-4d4475d3d8a4"
      },
    ...
    {
      "object": "block",
      "id": "7f0baf84-fa96-4bc0-87e4-d38b059f5709",
      "parent": {
        "type": "page_id",
        "page_id": "f8b93766-ebbc-4211-a1e7-4d4475d3d8a4"
      },
      ...
      "blocks": [
        {
          "object": "block",
          "id": "72c8c769-4cde-4d4a-abe2-e42a81a5c6d6",
          "parent": {
            "type": "block_id",
            "block_id": "7f0baf84-fa96-4bc0-87e4-d38b059f5709"
          },
          "created_time": "2022-01-28T00:21:00.000Z",
          "last_edited_time": "2022-01-28T00:21:00.000Z",
          "created_by": {
          ...
          "blocks": [
            {
              "object": "block",
              "id": "0b1a9d3b-c264-47cd-94d3-61994d38f3cb",
              "parent": {
                "type": "block_id",
                "block_id": "72c8c769-4cde-4d4a-abe2-e42a81a5c6d6"
              },
              "created_time": "2022-01-28T00:21:00.000Z",
              "last_edited_time": "2022-01-28T00:21:00.000Z",
              "created_by": {
        ...
        {
          "object": "block",
          "id": "5e44c4f1-c000-4610-a811-19aae862b11d",
          "parent": {
            "type": "block_id",
            "block_id": "7f0baf84-fa96-4bc0-87e4-d38b059f5709"
          },
          ...
          "blocks": [
            {
              "object": "block",
              "id": "766c8dda-ff93-4125-9dac-d688ea636899",
              "parent": {
                "type": "block_id",
                "block_id": "5e44c4f1-c000-4610-a811-19aae862b11d"
              },
              "created_time": "2022-01-28T00:21:00.000Z",
              "last_edited_time": "2022-01-28T00:21:00.000Z",
              "created_by": {
