const json = {
  ...
  "last_edited_time": "2022-12-08T08:25:00.000Z",
  "created_by": {
    "object": "user",
  ...
  "properties": {
    ...
    "Public URL": {
      ...
      "formula": {
        "type": "string",
        "string": "https://notion2svelte.vercel.app/other-components/divider"
      }
    },
    "SomeDateProp": {
      "id": "UMpq",
    ...
    "Local URL": {
      ...
      "formula": {
        "type": "string",
        "string": "http://localhost:5173/other-components/divider"
      }
    },
    "Name": {
      "id": "title",
