...
<Image url="/assets/components/numbered-list-item/649e379b-c64f-4e8c-85a8-14c9138c9cad.png" />
...
<Code
  code={`<NumberedListItem number="1">First level</NumberedListItem>
<IndentGroup>
...
>
  <InlineColor value="gray">Rendered by</InlineColor><MagicLink
    ...
    ><InlineColor value="gray">NumberedListItem.svelte</InlineColor></MagicLink
  >
</Paragraph>
...
<NumberedListItem number="2">2nd entry at 1st level</NumberedListItem>
<Header level={3}>Known bug</Header>
<Paragraph
  blockProps={{
    pageId: '52ce8803309d42ada3fd00cb9cd1c200',
...
>
  Note: the current implementation is slightly naive, rotating the numbering styles on indentation,
  regardless of whether the “parent” block is itself a&nbsp;<em>numbered-list-item</em>.
</Paragraph>
<Paragraph
  blockProps={{
    pageId: '52ce8803309d42ada3fd00cb9cd1c200',
...
/>
<BulletedListItem>This next line should begin with a 1. but…it doesn’t.</BulletedListItem>
<IndentGroup>
  <NumberedListItem number="a">First numbered item</NumberedListItem>
</IndentGroup>
<Paragraph
  blockProps={{
    pageId: '52ce8803309d42ada3fd00cb9cd1c200',
