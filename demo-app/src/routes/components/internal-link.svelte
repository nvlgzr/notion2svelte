...
>
  Internal links — both @mentions (<MagicLink href="/rules-for-writing-good-slugs"
    >Writing Good Slugs</MagicLink
  >) and&nbsp;<a href="/rules-for-writing-good-slugs">links to internal pages</a>&nbsp;— get
  rendered as&nbsp;<em>InternalLink</em>&nbsp;components
</Paragraph>
<Paragraph
  blockProps={{
    pageId: '0a81110f311a4b2f858a65ea1a45ab3a',
