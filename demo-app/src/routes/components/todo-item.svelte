...
<Image url="/assets/components/todo-item/7abddc48-4a58-4ee4-a54a-564f33422a1d.png" />
...
<Code
  code={`<TodoItem checked=\{false} block-props=\{\{…}}>Remember the milk</TodoItem>`}
  language="html"
  caption=""
...
>
  <InlineColor value="gray">Rendered by</InlineColor><MagicLink
    ...
    ><InlineColor value="gray">TodoItem.svelte</InlineColor></MagicLink
  >
</Paragraph>
