...
>
	Green squiggly rendered by&ensp;<Link
		...
		><InlineColor value="gray">Underline.svelte</InlineColor></Link
	>
</Paragraph>
<Paragraph
	blockProps={{
...
>
	In general, the use of&ensp;<Underline>underlining</Underline>&ensp;is as&ensp;<Link
		type="absolute"
		href="https://practicaltypography.com/underlining.html">contraindicated</Link
	>&ensp;as is the passive voice.
</Paragraph>
<Divider />
<Header level={2}
