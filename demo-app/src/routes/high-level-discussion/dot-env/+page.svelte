...
>
	Since the content of that page often didn’t change much, I also found myself wanting to run the
	JSON→.svelte conversion without re-fetching each time. Thus were born these last three options:
</Paragraph>
<Code
