const json = {
  ...
  "properties": {
    ...
    "Public URL": {
      ...
      "formula": {
        "type": "string",
        "string": "https://notion2svelte.vercel.app/standard-components/callout"
      }
    },
    "SomeDateProp": {
      "id": "UMpq",
    ...
    "Local URL": {
      ...
      "formula": {
        "type": "string",
        "string": "http://localhost:5173/standard-components/callout"
      }
    },
    "Name": {
      "id": "title",
  ...
  "blocks": [
    ...
    },
    {
      ...
      "image": {
        ...
        "type": "file",
        "file": {
          "url": "https://s3.us-west-2.amazonaws.com/secure.notion-static.com/e06190a3-d411-4fed-b66f-6ed510abe8d4/Untitled.png?X-Amz-Algorithm=AWS4-HMAC-SHA256&X-Amz-Content-Sha256=UNSIGNED-PAYLOAD&X-Amz-Credential=AKIAT73L2G45EIPT3X45%2F20221208%2Fus-west-2%2Fs3%2Faws4_request&X-Amz-Date=20221208T233138Z&X-Amz-Expires=3600&X-Amz-Signature=cb1d7a08b00f2a1de7fe92663e96af1a2fd8aae124d6b870f49b05055b3518cd&X-Amz-SignedHeaders=host&x-id=GetObject"
        }
      }
    },
    {
