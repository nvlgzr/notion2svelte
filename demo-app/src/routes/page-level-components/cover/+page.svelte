	...
	<span slot="children"
		...
		<IndentGroup>
			...
			<NumberedListItem number="c">
				Use relative links to point the <InlineCode code={'src'} /> attribute at the (full res! 🙀) images</NumberedListItem
			>
		</IndentGroup>
		<Paragraph
			blockProps={{
...
/><TodoItem checked={false}
	>2022-02-25T14:00:00.000-08:00 TODO: download cover + icon images, rather than relying on expiring
	Amazon links</TodoItem
>
...
>
	...
	longer because it starts with <InlineCode code={'http'} />, in which case you should treat it as
	an image URL.
</Paragraph>
<Code code={`$: assumeURL = iconEmojiOrURL.length &gt; 3;`} language="javascript"
	...
	they’re all super long. Brittle, I know. ¯\_(ツ)_/¯</Code
><Paragraph
	blockProps={{
		pageId: 'df34058b281e4da6badc0a15a891d18e',
