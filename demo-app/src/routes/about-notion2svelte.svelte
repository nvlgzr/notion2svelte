...
<br style="display:none;" />
<Equation block={true} katexString="Notion → notion2svelte → Svelte" />
<br style="display:none;" />
<ColumnList cols={2}
  ><Column
...
<Paragraph
  blockProps={{
    ...
    last_edited_time: '2022-01-22T20:22:00.000Z'
  }}
>
  That said, I hope you’ll at least give it&nbsp;<MagicLink
    href="https://www.youtube.com/watch?v=xvV8-R_uUHg&t=12s"
    ><InlineColor value="yellow_background">a quick try</InlineColor></MagicLink
...
<Paragraph
  blockProps={{
    ...
    last_edited_time: '2022-01-11T05:18:00.000Z'
  }}
>
...
<Paragraph
  blockProps={{
    pageId: 'fdc65179a8bd451caf6759019204cfde',
    id: '373fc2b7-6d70-4c1b-98bd-3f9e21005607',
    created_time: '2022-01-09T05:40:00.000Z',
    last_edited_time: '2022-01-09T05:40:00.000Z'
  }}
/>
...
<Paragraph
  blockProps={{
    ...
    created_time: '2022-01-04T23:43:00.000Z',
    last_edited_time: '2022-01-11T07:07:00.000Z'
  }}
>
  The output .svelte files make use of user-defined components to do the actual rendering. Let’s use
  a Notion “callout” as a simple example.
</Paragraph>
...
<Paragraph
  blockProps={{
    pageId: 'fdc65179a8bd451caf6759019204cfde',
    id: 'fb0f84ae-a551-4ace-a699-0aef7dfa7024',
    created_time: '2022-01-11T07:07:00.000Z',
    last_edited_time: '2022-01-11T07:07:00.000Z'
  }}
/>
...
>
  How do we get from this ↑ to something like this ↓?
</Paragraph>

<br style="display:none;" />
<Callout emoji="🦦">Hi. I’m a sea otter.</Callout>
<br style="display:none;" />
<Paragraph
  blockProps={{
    pageId: 'fdc65179a8bd451caf6759019204cfde',
...
<br style="display:none;" />
<Header level="2">Find the code, start a discussion, or report an issue on GitHub</Header>
...
<br style="display:none;" />
<Header level="2">Browse the docs</Header>

<br style="display:none;" />
<ColumnList cols={2}
  ><Column
    ><Header level="3">High-level</Header>
    <BulletedListItem
      ><p
    ...
    ><Header level="3">All&nbsp;<em>notion2svelte</em>-compatible Components</Header>
    <BulletedListItem
      ><p
        style="display: inline-block; background: floralwhite; padding: 1rem; margin: 0.25rem 0; border: 1px fuchsia solid; border-radius: 6px; "
      >
    ...
    <BulletedListItem
      ...
      >
        ⚠️ k(t, url): <span
          style="font-weight: 600; display: inline; padding: 3px; border-radius: 3px;">Header.</span
        >&nbsp;No URL provided for Header.<br /><br />Did you give it a Slug, mark it Publishable,
    ...
    <BulletedListItem
      ...
      >
        ⚠️ k(t, url): <span
          style="font-weight: 600; display: inline; padding: 3px; border-radius: 3px;">To-do.</span
        >&nbsp;No URL provided for To-do.<br /><br />Did you give it a Slug, mark it Publishable,
        and run _notion2svelte_?
      </p>
      &nbsp;</BulletedListItem
    >
    <BulletedListItem
      ...
      >
        ⚠️ k(t, url): <span
          style="font-weight: 600; display: inline; padding: 3px; border-radius: 3px;">Page.</span
        >&nbsp;No URL provided for Page.<br /><br />Did you give it a Slug, mark it Publishable, and
        run _notion2svelte_?
      </p>
      &nbsp;</BulletedListItem
    >
