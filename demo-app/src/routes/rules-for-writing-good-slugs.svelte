...
>
  ...
  has a slug of “foo/bar/baz,”&nbsp;<em>notion2svelte</em>&nbsp;will save a file at&nbsp;<em
    >src/routes/foo/bar/baz.svelte.</em
  >&nbsp;This has subtle consequences…which can be&nbsp;<em>ignored</em>&nbsp;if you follow two
  simple rules:
</Paragraph>
...
<IndentGroup>
  ...
  >
    ❌ <InlineCode code={'/blog/index'} />&nbsp;→&nbsp;<InlineCode
      code={'/routes/blog/index.svelte'}
    />
  </Paragraph>
  <Paragraph
    blockProps={{
...
>
  Say we have a page in our Notion database with the Slug,&nbsp;<InlineCode code={'link-target'} />.
  Then you run&nbsp;<em>notion2svelte</em>. This’ll get you…
</Paragraph>
<BulletedListItem
...
<IndentGroup>
  ...
  >
    *I say&nbsp;<em>probably</em>, because it’s up to you how you implement your&nbsp;<MagicLink
      href="/components/internal-link">InternalLink</MagicLink
    >&nbsp;component.&nbsp;
  </Paragraph>
</IndentGroup>
<Paragraph
...
>
  Now let’s say that you have two pages linking&nbsp;<em>to</em>&nbsp;“link-target”,&nbsp;<em
    >one</em
  >&nbsp;and&nbsp;<em>two</em>, like so
</Paragraph>
<Code
  code={`├── src
│   └── routes
...
>
  ...
  click the&nbsp;<InlineCode code={'href=&quot;link-target&quot;'} />&nbsp;link in the page
  generated from&nbsp;<em>one.svelte</em>&nbsp;(<em>https://foo.io/one),</em>&nbsp;the URL resolves
  to&nbsp;<em>https://foo.io</em>&nbsp;+&nbsp;<em>link-target</em>&nbsp;⇒&nbsp;<em
    >https://foo.io/link-target</em
  >. So far so good!
</Paragraph>
<Paragraph
  blockProps={{
...
>
  ...
  >. Now, when we click the link, it resolves to&nbsp;<em>htttps://foo.io/subpages/link-target</em
  >&nbsp;which, of course, does not exist, leading to a 404 😥.
</Paragraph>
...
>
  As you probably know, Svelte has special rules for it handles pages named&nbsp;<em
    >index.svelte</em
  >. In particular, Svelte expects the page name to&nbsp;<em>not</em>&nbsp;be referenced when
  navigating to an index page.
</Paragraph>
<Paragraph
  blockProps={{
    pageId: '57ec9a2db8544bf694a45f0e2a0b68d1',
...
>
  <em>notion2svelte</em>&nbsp;can create such a page easily enough. Just give the page a Slug of /<em
    >subpages/index</em
  >. The problem here is that links created by&nbsp;<em>notion2svelte</em>&nbsp;will end up with
  URLs like&nbsp;<InlineCode code={'https://foo.io/subpages/index'} />, which Svelte doesn’t
  recognize.
</Paragraph>
...
>
  All is well and good with this approach, so long as you aren’t taking advantage of Svelte
  Kit’s&nbsp;<em>__layout.svelte</em>&nbsp;pages.
</Paragraph>
<Code
  code={`├── src
│   └── routes
...
>
  Unlike a&nbsp;<em>subpages/index.svelte</em>&nbsp;page,&nbsp;<em>subpages.svelte</em>&nbsp;is
  unable to participate in whatever behaviors and/or styles are on offer by&nbsp;<em
    >__layout.svelte</em
  >.
</Paragraph>
<Paragraph
...
>
  This is a real problem, hopefully to be addressed by a future version of&nbsp;<em
    >notion2svelte.</em
  >
</Paragraph>
