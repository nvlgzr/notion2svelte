const json = {
  ...
  "properties": {
    ...
    "Public URL": {
      ...
      "formula": {
        "type": "string",
        "string": "https://notion2svelte.vercel.app/layout-only-components/indent-group"
      }
    },
    "SomeDateProp": {
      "id": "UMpq",
    ...
    "Local URL": {
      ...
      "formula": {
        "type": "string",
        "string": "http://localhost:5173/layout-only-components/indent-group"
      }
    },
    "Name": {
      "id": "title",
