  ...
  for (let block of blocks) {
    try {
      if (block.type !== 'unsupported') {
        // At some point, I'll probably reverse this change, but for
        // now, it'll be nice not to have the last_edited_time on
        // every. single. block. If nothing else, commits from here on
        // will be cleaner.
        ...
        const pageOnly = { ...removeProperty('last_edited_time',page), ...{ blocks: [] } }
